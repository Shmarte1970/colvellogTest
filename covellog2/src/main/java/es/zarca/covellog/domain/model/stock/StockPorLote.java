...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StockPorLote.findAll", query = "SELECT s FROM StockPorLote s"),
    @NamedQuery(name = "StockPorLote.findById", query = "SELECT s FROM StockPorLote s WHERE s.id = :id"),
    @NamedQuery(name = "StockPorLote.findByLote", query = "SELECT s FROM StockPorLote s WHERE s.lote = :lote"),
    @NamedQuery(name = "StockPorLote.findByStock", query = "SELECT s FROM StockPorLote s WHERE s.stock = :stock")})
public class StockPorLote implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final StockPorLote other = (StockPorLote) obj;
