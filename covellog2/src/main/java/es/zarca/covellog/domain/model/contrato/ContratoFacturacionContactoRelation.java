 ...
 */
@Entity
@Table(name = "contrato_facturacion_contactos_relation")
@XmlRootElement
class ContratoFacturacionContactoRelation implements Serializable {
    ...
    public ContratoFacturacionContactoRelation() {
        id = new ContratoContactoRelationPK();
    }

    public ContratoFacturacionContactoRelation(Contrato contrato, Contacto contacto, Integer nivel) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ContratoFacturacionContactoRelation)) {
            return false;
        }
        ContratoFacturacionContactoRelation other = (ContratoFacturacionContactoRelation) object;
