...
// este en el padre @Inheritance( strategy = InheritanceType.JOINED )
@XmlRootElement
public class Potencial2 implements Serializable {
    ...
    private String nom;
    @OneToMany(mappedBy = "potencial")
    private Collection<Oportunitat> oportunitatCollection;

    public Potencial2() {
    }

    public Potencial2(Integer id) {
        this.id = id;
    }

    public Potencial2(Integer id, String nom) {
        this.id = id;
        this.nom = nom;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Potencial2)) {
            return false;
        }
        Potencial2 other = (Potencial2) object;
    ...
    public String toString() {
        return "es.zarca.covellog.domain.model.crm.oportunitat.Potencial[ id=" + id + " ]";
    }
