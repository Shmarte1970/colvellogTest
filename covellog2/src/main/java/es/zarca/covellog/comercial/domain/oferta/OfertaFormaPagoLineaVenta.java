 ...
 */
@Entity
@Table(name = "oferta_forma_pago_linea_venta")
@XmlRootElement
public class OfertaFormaPagoLineaVenta extends FormaPagoLinea implements Serializable {
    ...
    public OfertaFormaPagoLineaVenta() {
    }
    
    public OfertaFormaPagoLineaVenta(Oferta oferta, Integer numLinea, Integer porcentaje, TipoPago tipoPago, String cuenta, TipoVencimiento tipoVencimiento, Integer diaPago) {
