 ...
 * @author francisco
 */
@Named("desbloquearStockBean")
@ViewScoped
public class DesbloquearStockBean extends GuardarCancelarBean implements Serializable {
    private static final Logger LOGGER = Logger.getLogger(DesbloquearStockBean.class.getName());
    @Inject
    ...
    public void guardar(ActionEvent event) {
        ...
        try {
            ...
            facade.desbloquear(ids, fecha, observaciones);
