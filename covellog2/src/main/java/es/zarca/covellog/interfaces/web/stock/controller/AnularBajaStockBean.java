 ...
 * @author francisco
 */
@Named("anularBajaStockBean")
@ViewScoped
public class AnularBajaStockBean extends GuardarCancelarBean implements Serializable {
    private static final Logger LOGGER = Logger.getLogger(AnularBajaStockBean.class.getName());
    @Inject
    ...
    public void guardar(ActionEvent event) {
        ...
        try {
            ...
            facade.reincorporarBaja(ids, fecha, observaciones);
            JsfUtil.addSuccessMessage(String.valueOf(ids.size()) + " stocks recuperados correctamente");
