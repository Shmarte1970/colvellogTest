...
@Named("peticionsContactePendentsController")
@SessionScoped
public class PeticionsContactePendentsController implements Serializable {
    private static final Logger logger = Logger.getLogger(PeticionsContactePendentsController.class.getName());
    ...
    public PeticionsContactePendentsController() {
    }
    ...
    public static class GestioPeticioContacteControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            PeticionsContactePendentsController controller = (PeticionsContactePendentsController) facesContext.getApplication().getELResolver().
