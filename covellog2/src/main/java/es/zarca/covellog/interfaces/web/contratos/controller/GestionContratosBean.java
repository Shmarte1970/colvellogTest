 ...
 * @author francisco
 */
@Named("gestionContratosBean")
@ViewScoped
public class GestionContratosBean implements Serializable {
    private static final Logger LOGGER = Logger.getLogger(GestionContratosBean.class.getName());
    @Inject
    ...
    public void prepareNuevo() {
        ...
        try {
            ...
            crearContratoBean.setOnGuardarListener( (event) -> {
                items = null;
                accionActual = GestionContratosBean.AccionPanel.LISTA;
    ...
    public void prepareModificar() {
        ...
        try {
            ...
            context.getApplication().getNavigationHandler().handleNavigation(context, null, "/contratos/modificar?faces-redirect=true&id=" + selecteds.get(0).getId());
            /*modificarContratoBean.prepare(selecteds);            
