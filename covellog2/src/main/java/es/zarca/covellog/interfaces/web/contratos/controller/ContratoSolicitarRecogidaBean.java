 ...
 * @author francisco
 */
@Named("contratoSolicitarRecogidaBean")
@ViewScoped
public class ContratoSolicitarRecogidaBean extends GuardarCancelarBean implements Serializable {
    private static final Logger LOGGER = Logger.getLogger(ContratoSolicitarRecogidaBean.class.getName());
    @Inject
    ...
    public void guardar(ActionEvent event) {
        ...
        try {            
            ...
            facade.solicitarRecogidaProductos(getContrato().getId(), ids, fecha);
