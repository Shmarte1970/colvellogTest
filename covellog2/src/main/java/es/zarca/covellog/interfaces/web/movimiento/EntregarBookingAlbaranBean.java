 ...
 * @author francisco
 */
@Named("entregarBookingAlbaranBean")
@ViewScoped
public class EntregarBookingAlbaranBean extends GuardarCancelarBean implements Serializable {
    private static final Logger LOGGER = Logger.getLogger(EntregarBookingAlbaranBean.class.getName());
    @Inject
    ...
    public EntregarBookingAlbaranBean() {
    }
    ...
    protected void guardarImpl() {
        ...
        try {
            ...
            Integer reservaId = facade.generarMovimiento(
                albaranId, 
                fecha, 
                asignacionesForm,
                transportistaId, 
    ...
    @FacesConverter(value="EntregarBookingAsignacionConverter")
    public static class EntregarBookingAsignacionConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EntregarBookingAlbaranBean bean = (EntregarBookingAlbaranBean) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "entregarBookingAlbaranBean");
