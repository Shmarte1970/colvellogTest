 ...
 */
@Stateless
@Path("es.zarca.covellog.domain.model.producto.tipoproducto")
public class TipoProductoFacadeREST extends AbstractFacade<TipoProducto> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, TipoProducto entity) {
        super.edit(entity);
    }
    ...
    public TipoProducto find(@PathParam("id") String id) {
