 ...
 */
public class TipoClienteNotExistException extends BusinessException {

    public TipoClienteNotExistException(Integer idEmpresa) {
        super(crearMessageIdEmpresa(idEmpresa));
    }
    
    public TipoClienteNotExistException(String nombre) {
